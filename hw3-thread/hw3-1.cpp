...
void proc_img(void* img_ptr)
{
	...
	// read input BMP file
	pic_in = bmpReader->ReadBMP(img.inputFile, &imgWidth, &imgHeight);
	// allocate space for output image
	unsigned char* pic_grey = (unsigned char*)malloc(imgWidth*imgHeight*sizeof(unsigned char));
	unsigned char* pic_blur = (unsigned char*)malloc(imgWidth*imgHeight*sizeof(unsigned char));
	unsigned char* pic_final = (unsigned char*)malloc(3 * imgWidth*imgHeight*sizeof(unsigned char));
